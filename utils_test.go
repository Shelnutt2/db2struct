...
`
	...
	bytes, err := Generate(columnMap, []string{"NullStringColumn", "StringColumn"}, "test_table", "testStruct", false, false, false, false)
...
`
	...
	bytes, err := Generate(columnMap, []string{"nullStringColumn", "stringColumn"}, "test_table", "testStruct", false, false, true, false)
...
`
	...
	bytes, err := Generate(columnMap, []string{}, "test_table", "testStruct", false, false, false, false)
...
`
	...
	bytes, err = Generate(columnMap, []string{}, "test_table", "testStruct", false, false, false, true)
...
`
	...
	bytes, err := Generate(columnMap, []string{}, "test_table", "testStruct", true, false, false, false)
...
`
	...
	bytes, err := Generate(columnMap, []string{}, "test_table", "testStruct", false, true, false, false)
